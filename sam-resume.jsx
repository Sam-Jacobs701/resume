...
const SkillCard = ({ icon, title, skills, color = '#00ffd5', size = 'normal' }) => {
  const [isHovered, setIsHovered] = useState(false);
...
const TimelineItem = ({ title, company, period, description, isLast = false, delay = 0 }) => (
  <ScrollReveal delay={delay}>
    <div style={{ display: 'flex', gap: '24px', position: 'relative' }}>
      ...
      <div style={{ paddingBottom: isLast ? '0' : '48px', flex: 1 }}>
        <div style={{
          fontFamily: "'JetBrains Mono', monospace",
          fontSize: '12px',
          color: '#00ffd5',
